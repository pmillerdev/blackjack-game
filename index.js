...
function dealNew() {
  ...
  if (mypounds < 0) {
    ...
    message.innerHTML =
      "Get up to 21 and beat the dealer to win<br>Current bet is £" +
      betvalue +
      "<br>";
...
function cardOutput(n, x) {
  ...
  return (
    ...
    "px; z-index: " +
    zIndex +
    '"><div class="card-top-section suit">' +
    cards[n].cardnum +
    '<br></div><div class="card-middle-section suit"></div><div class="card-bottom-section suit">' +
    cards[n].cardnum +
    "<br></div></div>"
  );
}
...
function playend() {
  ...
  if (
    ...
    message.innerHTML +=
      '<span style="color: #5cb85c;">Congratulations! You won £' +
      betvalue +
      "!</span>";
    ...
    message.innerHTML +=
      '<span style="color: #428bca;">PUSH - All bets are returned</span>';
    mypounds = mypounds + betvalue;
  } // Dealer victory otherwise
  else {
    message.innerHTML +=
      '<span style="color: #d9534f;">Dealer wins! You lost £' +
      betvalue +
      "</span>";
  }
  // Update amounts
